 ...
 * - Fully responsive for mobile / tablet / desktop (Samsung / iPhone / etc.)
 */
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-3 sm:p-4">
      <div className="flex items-start gap-3">
        <div
          className={cn(
            "h-10 w-10 rounded-2xl flex items-center justify-center border border-slate-200 bg-slate-100 shrink-0",
        ...
        <div className="min-w-0 flex-1">
          <div className="text-sm font-extrabold text-slate-900 break-words">{toast.text}</div>
          <div className="mt-0.5 text-xs text-slate-600 break-words">
            {isError ? "Please check the fields and try again." : "Thanks! Your report is saved."}
          </div>
        </div>
        ...
        <button
          type="button"
          onClick={onClose}
          className="shrink-0 p-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50"
          aria-label="Close"
          title="Close"
        >
...
function Field({ label, icon, hint, className = "", ...props }) {
  return (
    <div className={className}>
      <label className="mb-1.5 block text-sm font-extrabold text-slate-900">{label}</label>
      <div className="relative">
        ...
        <input
          {...props}
          className={cn(
            "w-full rounded-2xl border border-slate-200 bg-white px-10 py-2.5 text-sm text-slate-900 outline-none transition",
            "focus:ring-4 focus:ring-blue-600/10 focus:border-blue-600"
          )}
        />
      </div>
      <div className="mt-1 text-[11px] text-slate-400 min-h-[14px]">{hint || ""}</div>
    </div>
  );
}
...
export default function TeamManagement() {
  ...
  return (
    <div className="bg-slate-50 rounded-2xl p-3 sm:p-4 md:p-6 space-y-4">
      {/* Header */}
      <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden">
        <div className="relative p-4 sm:p-5">
          {/* subtle blobs using allowed colors */}
          <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-slate-100 blur-3xl" />
          <div className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full bg-slate-100 blur-3xl" />

          <div className="relative flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0">
              <h1 className="text-lg sm:text-xl font-extrabold text-slate-900 truncate">Team Management</h1>
            ...
            <div className="flex flex-col sm:items-end gap-2">
              <div className="rounded-2xl border border-slate-200 bg-slate-100 px-3 py-2 text-xs font-extrabold text-slate-900">
                {canSubmit ? (
      ...
      <div className="grid gap-4 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 space-y-4">
          {/* Using your Card component (kept) */}
          <Card title="Daily Report Submission">
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              {/* Textarea */}
              <div className="rounded-2xl border border-slate-200 bg-white p-3 sm:p-4">
                <label className="mb-2 block text-sm font-extrabold text-slate-900">Daily Report</label>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className={cn(
                      "w-full rounded-2xl border border-slate-200 bg-slate-50 px-10 py-3 text-sm text-slate-900 outline-none transition",
                      "focus:ring-4 focus:ring-blue-600/10 focus:border-blue-600",
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="min-w-0">
                    <div className="text-sm font-extrabold text-slate-900">Attachment (optional)</div>
                    <div className="text-xs text-slate-600 break-words">
                  ...
                  <label
                    className={cn(
                      "inline-flex w-full sm:w-auto cursor-pointer items-center justify-center gap-2 rounded-2xl",
                      "bg-blue-600 px-4 py-2.5 text-sm font-extrabold text-white",
                  ...
                  <div className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 p-3">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <button
                        ...
                        onClick={removeFile}
                        className={cn(
                          "inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl",
                          "border border-slate-200 bg-white px-3 py-2 text-sm font-extrabold text-slate-900",
                          "hover:bg-slate-50"
                        )}
                      >
              ...
              <button
                ...
                className={cn(
                  ...
                  "bg-green-600 px-4 py-3 text-sm font-extrabold text-white",
              ...
              {!canSubmit ? (
                <div className="rounded-2xl border border-slate-200 bg-slate-100 p-3 text-xs text-slate-600">
                  Fill <b className="text-slate-900">Name</b>, select <b className="text-slate-900">Date</b>, and write
                  your <b className="text-slate-900">Daily Report</b> to enable submit.
                </div>
              ) : null}
            </form>
          </Card>

          {/* Mobile-only quick guide (keeps RHS info visible on phones) */}
          <div className="lg:hidden">
            <SectionCard title="Daily Report Format" subtitle="Quick checklist for fast reporting">
        ...
        <div className="lg:col-span-2 space-y-4"> 
          <Card title="Reporting Manager">
            ...
            <div className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-600">
              <div className="font-extrabold text-slate-900">Daily Report Format</div>
          ...
          <Card title="Collaboration Tools">
            <div className="text-sm text-slate-600 break-words">
              Internal team communication tools will be added here (chat, tasks, approvals).
            </div>

            <div className="mt-3 rounded-2xl border border-slate-200 bg-white p-3">
              <div className="text-xs font-extrabold text-slate-900">Quick Tips</div>
              <div className="mt-1 text-xs text-slate-600 leading-relaxed">
                Keep the report short but clear. Use bullet points for tasks and mention measurable outcomes.
              </div>
            </div>
          </Card>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-3">
            <div className="text-xs font-extrabold text-slate-900">Status Colors</div>
